...
public sealed class DataLinkMachine
{
    ...
    private bool EvaluateAtom(string atom)
    {
        ...
        return atom switch
        {
            ...
            // packethacking/ax25spec#40: V(r) < N(s) < V(r)+k, a modular open
            // interval; k is the window this receiver granted.
            "vr_lt_ns_lt_vr_plus_k" => Distance(Vr, RequireNs(atom)) is var d && d > 0 && d < K,
